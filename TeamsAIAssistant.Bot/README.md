...
- In a terminal, navigate to `TeamsAIAssistant.Bot`

    ```bash
    # change into project folder
    cd TeamsAIAssistant.Bot
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `TeamsAIAssistant.Bot` folder
  - Select `TeamsAIAssistant.Bot.csproj` file
